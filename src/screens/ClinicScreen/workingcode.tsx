...
const doctorsDataLatest = {
    "13": [
        {
            ...
            bookedSlots: ["11:00 AM"] // Example booked slot 
        },
        {
            id: 2,
            name: "Dr. B",
    ...
    "14": [
        ...
        },
        {
            ...
            bookedSlots: [] // No booked slots for now
        }
    ],
    "15": [
        {
            ...
            name: "Dr. E",
            image: "url5",
            slots: ["08:00 AM", "09:00 AM", "10:30 AM"],
        ...
        },
        {
            ...
            name: "Dr. F",
            image: "url6",
            slots: ["12:30 PM", "03:00 PM", "05:00 PM"],
            bookedSlots: ["03:00 PM"]
        }
    ],
    "16": [
        {
            ...
            name: "Dr. G",
            image: "url7",
            slots: ["09:30 AM", "11:00 AM", "12:00 PM"],
            bookedSlots: ["11:00 AM", "12:00 PM"]
        }
    ]
};
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.doctorContainer}>
                {Array.isArray(doctorsData[selectedDate]) ? (
                    doctorsData[selectedDate].map((doctor: any, index: number) => (
                    ...
                    <View style={styles.doctorBox}>
                        <Image source={{ uri: doctorsData[selectedDate].image }} style={styles.doctorImage} />
                        <Text style={styles.doctorName}>{doctorsData[selectedDate].name}</Text>
                    </View>
                )}
            </View>
