...
export const VESTIGE_IMAGE = {
  ...
  LOCATION_ICON_NEW: require('../../assets/images/locatio_pin.png'),
  ...
  BACK_NEW_ICON: require('../../assets/images/left_icon.png')
};
...
export const PICKER_ENUM = {
  ...
  TRAININGTYPE_PICKER_CNT: 'trainingTypeCnt'
}
